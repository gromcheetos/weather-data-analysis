...
public class WeatherDataController {
	...
	public void getAllWeather() {
		...
		weatherView.printMessage("Every weather: " + allData);
	}
	...
	public void findMinTemp() {
		WeatherDataResult data  = weatherStorage.findMinTempReading();
		weatherView.printMessage("Minimum Temperature by the all stats: " + data.getTemp() +" in " + data.getState());		
	}
	
	public void findAvgTemp() {
		WeatherDataResult data  = weatherStorage.findAverageTempReading();
		weatherView.printMessage("Average Temperature by the all stats: " + data.getTemp() +" in " + data.getState());
	}
